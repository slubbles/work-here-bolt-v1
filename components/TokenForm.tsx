...
import { LoadingProgress, LoadingSpinner, PulsingDot } from '@/components/ui/loading-progress';
    ...
    return (
      <div className="min-h-screen bg-background flex items-center justify-center">
        <div className="text-center space-y-4">
          ...
          <p className="text-muted-foreground">Loading token creation form...</p>
        </div>
      </div>
    );
  }
          ...
          <CardContent className="p-6">
            <div className="space-y-4">
              <div className="flex items-center justify-center space-x-3">
                ...
                <h3 className="text-lg font-semibold text-foreground">Creating Your Token</h3>
              </div>
              <LoadingProgress
                isLoading={isDeploying}
                progress={deploymentProgress}
                loadingText={
                  deploymentProgress < 20 ? 'Preparing transaction...' :
                  deploymentProgress < 40 ? 'Uploading metadata...' :
                  deploymentProgress < 60 ? 'Creating token on blockchain...' :
                  deploymentProgress < 80 ? 'Confirming transaction...' :
                  deploymentProgress < 95 ? 'Setting up wallet access...' :
                  'Finalizing...'
                }
                showPercentage={true}
                colorScheme="default"
              ...
              <p className="text-center text-sm text-muted-foreground">
                Please don't close this page. This process takes about 30 seconds.
              </p>
            </div>
          </CardContent>
        </Card>
                ...
                <div className="flex items-center justify-between">
                  <div className="flex items-center space-x-3">
                    <div className="flex items-center space-x-2">
                      ...
                      {tokenData.network === network.value && <PulsingDot size="sm" color="red" />}
                    </div>
                    <div>
                      <div className="flex items-center space-x-2">
